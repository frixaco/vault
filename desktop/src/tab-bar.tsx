...
export function TabBar({
  ...
  return (
    ...
    >
      {tabs.map((tab) => {
        const hasVisibleLabel = tab.label.trim().length > 0;
        const showDivider = hasVisibleLabel && hasSeenVisibleTab;
        if (hasVisibleLabel) hasSeenVisibleTab = true;
